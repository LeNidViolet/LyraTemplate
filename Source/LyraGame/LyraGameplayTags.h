...
namespace LyraGameplayTags
{
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Nameplate_Add);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Nameplate_Remove);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Nameplate_Discover);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Marker_Add);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Marker_Remove);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Marker_Discover);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Callout_Display);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Session_MemberEvent);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Lobby_MemberEvent);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Lobby_Countdown);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_Inventory_StackChanged);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gameplay_Message_UI_FocusNavi);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_Placeholder);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_Duration_Message);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_Pickup_Active);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_Pickup_Auto);
