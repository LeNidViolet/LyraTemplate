...
namespace LyraGameplayTags
{
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(ToastMessage_Lobby_MemberEvent);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(ToastMessage_Lobby_Countdown);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(ToastMessage_Session_MemberEvent);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Focus_Navi);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Inventory_Stack_Changed);
